...
def load_coco_dataset(datasets):
    ...
    for dataset in datasets:
        annfile = '%s/annotations/instances_%s.json' % (source_dir, dataset)
        coco = COCO(annfile)
...
if __name__ == "__main__":
    ...
    coco_anchors = kmeans_iou(k, centroids, coco_data, feature_size=img_size // 16)
    print(coco_anchors.round(2).tolist())
